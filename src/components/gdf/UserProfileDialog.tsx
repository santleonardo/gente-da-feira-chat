          ...
          <>
            ...
            <div className="px-5 pb-5 -mt-8">
              ...
              <div className="mt-4 flex gap-5">
                ...
                >
                  <p className="text-base font-bold">{followInfo.followingCount}</p>
                ...
                <button
                  ...
                  className="text-center hover:opacity-80 transition-opacity"
                >
                  <p className="text-base font-bold">{followInfo.followersCount}</p>
                  <p className="text-[11px] text-muted-foreground">Seguidores</p>
                </button>
              </div>

              {/* Tabs: Fotos / Seguidores / Seguindo */}
              <div className="mt-4">
                <div className="flex border-b">
                  <button
                    onClick={() => setActiveTab("fotos")}
                    className={`flex-1 pb-2 text-xs font-semibold text-center transition-colors flex items-center justify-center gap-1 ${
                      activeTab === "fotos"
